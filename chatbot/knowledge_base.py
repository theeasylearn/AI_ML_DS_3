knowledge = {
    'topics': {
        ...
        # ─────────────────────────────────────────────
        'about': {
            'keywords': ['about', 'what is', 'tell me about', 'easylearn', 'academy', 'who are you', 'introduction', 'institute', 'organization', 'company', 'what do you do', 'overview', 'info', 'information', 'background', 'history', 'founded', 'establishment'],
        ...
        # ─────────────────────────────────────────────
        'location': {
            'keywords': ['location', 'address', 'where', 'place', 'situated', 'find you', 'directions', 'how to reach', 'map', 'navigate', 'office', 'city', 'state', 'gujarat', 'bhavnagar', 'visit', 'near', 'landmark', 'pincode', 'area', 'road', 'mall'],
        ...
        # ─────────────────────────────────────────────
        # 6. CORPORATE TRAINING & OFFSHORE WORK
        # ─────────────────────────────────────────────
        'corporate_training': {
        ...
        # ─────────────────────────────────────────────
        'contact': {
            'keywords': ['contact', 'reach', 'call', 'phone', 'number', 'email', 'whatsapp', 'message', 'enquiry', 'inquiry', 'get in touch', 'support', 'help', 'connect', 'talk', 'speak', 'chat', 'customer care', 'helpline', 'toll free', 'reach out', 'how to contact', 'contact details', 'social media', 'facebook', 'instagram', 'linkedin', 'website'],
        ...
        # ─────────────────────────────────────────────
        # 11. ELIGIBILITY & STUDENT PROFILE
        # ─────────────────────────────────────────────
        'eligibility': {
